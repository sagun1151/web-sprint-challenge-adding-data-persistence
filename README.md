...
Relational databases are database management systems and SQL is the language used to communicate with the date in the RD

2. Why do tables need a Primary Key?

ensures row-level accessibility, uniquely identify that row
...
need and intermediary table that holds the foreign keys that references the primary keys on the related tables
